...
def main(_):
    ...
    data_loader = TextLoader(True, FLAGS.train_path, FLAGS.map_file_path, FLAGS.batch_size, FLAGS.seq_length, None, None, None, 'utf8', False)
    valid_data_loader = TextLoader(False, FLAGS.valid_path, FLAGS.map_file_path, FLAGS.batch_size, FLAGS.seq_length, data_loader.vocab, data_loader.labels, data_loader.std_label_map, 'utf8', False)
            ...
            for train_batch_num in range(data_loader.num_batches):  #for each batch
                ...
                if idx % FLAGS.check_every == 0:
                    ...
                    for _ in range(valid_data_loader.num_batches):
                        ...
                        feed = {bilstm.input_x: input_x_valid, bilstm.input_y: input_y_valid, bilstm.x_len: x_len_valid, bilstm.dropout_keep_prob: 1.0}
