...
test_data_loader = TextLoader(False, FLAGS.test_data_path, FLAGS.map_file_path, FLAGS.batch_size, FLAGS.seq_length, vocab_id, label_id, std_label_map, 'utf8', False)
...
with tf.Session(config=config) as sess:
    ...
    for n in range(test_data_loader.num_batches):
        ...
        prediction_result = sess.run(prediction, feed_dict={input_x:input_x_test, length_x:x_len_test, keep_prob:1.0})
        # print("n: " + str(n))
